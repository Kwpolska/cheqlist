# -*- coding: utf-8 -*-
#
# Cheqlist documentation build configuration file, created by
...
project = u'Cheqlist'
copyright = u'2015-2016, Chris Warrick'
...
latex_documents = [
  ('index', 'cheqlist.tex', u'Cheqlist Documentation',
   u'', 'manual'),
]
...
man_pages = [
    ('index', 'cheqlist', u'Cheqlist Documentation',
     [u''], 1)
]
